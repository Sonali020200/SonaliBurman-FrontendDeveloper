...
const Footer = () => {
  return (
    <div className="footer-section max-h-screen flex flex-col bg-gradient-radial from-blue-200/70 to-transparent">
      <div className="footer-middle flex flex-col md:flex-row justify-between items-center p-5 md:p-20 mb-12">
        ...
        <div className="flex flex-col gap-4 w-full md:w-1/2">
          <div className="text-white heading-gradient text-2xl text-center md:text-right bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">
            Looking for help?
          </div>
      ...
      <footer className="footer-bottom flex justify-between p-5 md:p-10 items-center border-t border-white mx-4">
