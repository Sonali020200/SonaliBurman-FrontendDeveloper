  ...
  return (
    <div>
            ...
            <div className='flex items-center justify-between lg:px-16'>
                ...
                <div className='w-44 lg:w-full flex border border-gray-200 rounded-lg m-2'>
                <span className='w-2 lg:w-6 bg-[#BE2C2C] dir-ltr rounded-s-lg'></span>
                 <div className='lg:pr-12 lg:py-2 flex text-xs lg:text-xl gap-2 lg:gap-8 m-2 items-center'>
